    ...
    >
      ...
      <div className="relative h-75 overflow-hidden">
        ...
        <div className="absolute top-4 left-4 right-4 flex lg:flex-col xl:flex-row gap-2 justify-between  items-start ">
          ...
          <div className="bg-white px-5 py-1 rounded-2xl shadow-xl flex items-center gap-2">
            <div className="font-semibold text-black">
              {currency} {car.pricePerDay}
            </div>
            <div className="text-xs text-black/80 font-medium">per day</div>
          </div>
        </div>
      ...
      <div className="relative bg-black p-6 space-y-4">
        ...
        <div className="grid grid-cols-4 lg:grid-cols-1 xl:grid-cols-4 gap-2">
          {specs.map((spec, index) => (
            <div
              key={index}
              className={`flex flex-col lg:flex-row xl:flex-col items-center lg:justify-between p-3 bg-slate-50 rounded-xl
              }`}
            >
