...
const Testimonial = () => {
  return (
    <div className="flex flex-col items-center gap-5 py-24">
      <div className="flex flex-col items-center max-w-130 text-center gap-1">
      ...
      <div className="flex md:flex-row flex-col gap-5">
        <div className={`${gs.glassCard} w-80 flex flex-col items-center p-10`}>
          <img
          ...
          <p className="text-center text-[15px] mt-3 text-gray-200">
