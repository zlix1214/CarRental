            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg border border-slate-200">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mt-6">
                {specs.map(({ icon, text }, idx) => (
                  <div
                    key={idx}
                    className="flex flex-col items-center p-2 sm:p-3 bg-slate-50 rounded-xl hover:bg-slate-100 transition-colors"
                  >
            ...
            <div className="bg-white rounded-2xl p-6 shadow-lg border border-slate-200">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                {features.map((feature, idx) => (
                  <div
                    key={idx}
                    className="flex items-center gap-3 p-2 bg-slate-50 rounded-xl hover:bg-slate-100 transition-colors"
                  >
